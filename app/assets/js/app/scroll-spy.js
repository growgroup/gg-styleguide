 ...
 * example:
 *
 * <div class="js-scrollspy-nav" data-responsive="950">
 *   <ul class="js-scrollspy-nav-wrap">
...
export default class ScrollSpy {
  ...
  constructor() {
    ...
    this.options = {
      ...
      navScrollWrapSelector: ".js-scrollspy-nav-wrap",
    ...
    responsive = $(this.options.navWrapSelector).data("responsive");
  ...
  activateIndex(element) {
    ...
    const navScrollWrapSelector = this.getOption("navScrollWrapSelector");
    ...
    if (currentActiveIndex !== null) {
      ...
      if (this.currentScrollTop > this.lastScrollTop) {
        ...
        document.querySelector(`${navSelector} ${navScrollWrapSelector}`).scrollLeft += prevEleWidth;
      } else {
        this.lastScrollTop = this.currentScrollTop;
        ...
        if (currentNode && currentNode.parentElement.previousElementSibling) {
          ...
          document.querySelector(`${navSelector} ${navScrollWrapSelector}`).scrollLeft -= prevSibling;
        } else {
          if (currentNode) {
            document.querySelector(`${navSelector} ${navScrollWrapSelector}`).scrollLeft = 0;
          }
        }
      }
    }
